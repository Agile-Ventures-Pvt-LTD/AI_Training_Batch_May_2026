...
def test_customer_profile_valid():
    result = get_customer_profile.invoke("CUST-100")
    assert isinstance(result, dict)
...
def test_card_details():
    result = get_card_details.invoke("CUST-100")
    assert isinstance(result, dict)
...
def test_statement_summary():
    result = get_statement_summary.invoke("CUST-100")
    assert isinstance(result, dict)
 
def test_rewards_summary():
    result = get_rewards_summary.invoke("CUST-100")
    assert isinstance(result, dict)
