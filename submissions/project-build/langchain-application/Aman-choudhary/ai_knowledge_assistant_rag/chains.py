...
def get_classification_chain():
    ...
    """
    llm = ChatGroq( groq_api_key=Config.GROQ_API_KEY,model_name=Config.GROQ_MODEL_NAME,temperature=0)
...
def get_grounded_rag_chain():
    ...
    """
    llm = ChatGroq(groq_api_key=Config.GROQ_API_KEY,model_name=Config.GROQ_MODEL_NAME,temperature=Config.TEMPERATURE)
