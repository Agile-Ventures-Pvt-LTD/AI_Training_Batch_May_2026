# Blog Intent Analysis with GROQ API
This project demonstrates how to use the GROQ API to analyze blog intent based on user-provided input. The application takes a structured blog request, sends it to the GROQ model for analysis, and saves the response in a JSON file.
