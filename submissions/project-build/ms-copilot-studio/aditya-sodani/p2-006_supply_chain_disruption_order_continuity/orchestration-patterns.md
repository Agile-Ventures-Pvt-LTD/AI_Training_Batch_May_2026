...
Autonomous Trigger ↓ Disruption Intake & Validation ↓ Scope Identification ↓ Recovery Planning ↓ Recovery Strategy Resolution ↓ Approval / Reassessment ↓ Final Validation ↓ Reporting
...
Specialist Failure ↓ Retry ↓ Success?
...
Condition Changed ↓ Reassessment Required ↓ Affected Specialist(s) ↓ Updated Findings ↓ Recovery Resolution ↓ Resolved?

If Yes:
Continue

If No:
Check Cycle Limit ↓ Manual Review
...
Final Recovery Plan ↓ Word Report + Excel Update + Outlook Notification
