...
3. Set ReassessmentRequired to true.
4. Rerun only affected specialists where possible.
5. Update specialist findings.
6. Increment ReassessmentCycle.
