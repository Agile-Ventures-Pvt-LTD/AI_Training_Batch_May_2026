RESOURCES = {
    "resource://travel/checklist": """Travel Readiness Checklist:
...
- Carry essential documents.""",
    ...
    "resource://travel/advisory-rules": """Weather Advisory Rules:
LOW:
...
def get_resource(resource_url: str):
    """Retrieves static system metadata based on custom resource protocol strings."""
    return RESOURCES.get(resource_url, None)
