DATASET_PATH="data/logistics_knowledge_base.txt"
...
def load_txt(Path=DATASET_PATH):
...
#retriver
def retrive_data(query:str, vector_store, top_k: int=TOP_K):
    result=vector_store.similarity_search_with_score(query, k=top_k)
